    ...
    ********************************************************** */
    Scenes.prototype.status = function(){
        if(typeof this.sceneStatus == 'undefined'){
            this.sceneStatus = "<div id='sceneStatus' style='position:absolute; z-index:1000000; -moz-box-sizing: border-box; box-sizing: border-box; padding:10px; font-size:12px; background-color:#000; color:#fff; width:180px;'></div>"
        ...
        this.sceneStatus.html(
            "current frame = " + this.frame.current.toFixed(1) + "<br>" +
            "total frame = " + this.frame.total + "<br>" + 
            "current scene = " + currentScene.id + "<br>" + 
            "current scene frame =" + (currentScene.frame.start-this.frame.current).toFixed(1)
        )
    }
