 ...
 */
 ...
 /* ************************************************************
    ...
    Scenes.addSceneFrameStartActor(sceneID3fn)
    ...
    Scenes.prototype.gotoFrame = function(tgFrame,option) {
        ...
        function onComplete(){
            ...
            if(scope.direction > 0){
                if(option.jump && typeof option.jump.next != "undefined")scope.gotoScene(scope.scene.scene.option.jump.next);
            }else{
                if(option.jump && typeof option.jump.prev != "undefined")scope.gotoScene(scope.scene.scene.option.jump.prev);
            }
        }
